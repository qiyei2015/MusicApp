...
public class HttpRequest<T> {
     ...
     * GET请求
     */
    public static final String GET = HttpManager.GET;

    /**
     * POST 请求
     */
    public static final String POST = HttpManager.POST;

    /**
     * DOWNLOAD 下载文件请求
     */
    public static final String DOWNLOAD = HttpManager.DOWNLOAD;

    /**
     * UPLOAD 上传文件请求
     */
    public static final String UPLOAD = HttpManager.UPLOAD;
    ...
    public static class Builder<T>{
         ...
         * @return 当前对象
         */
        public Builder<T> setPathUrl(String pathUrl) {
         ...
         * @return 当前对象
         */
        public Builder<T> setCache(boolean cache) {
         ...
         * @return 当前对象
         */
        public Builder<T> setApiClazz(Class<?> apiClazz) {
