...
public class ProgressInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        //上传请求
        if (HttpManager.UPLOAD.equals(task.getRequest().getMethod())){
            //设置带进度的响应实体
            if (mProgressRequestBody != null){
                Log.i(TAG,"mProgressRequestBody:" + mProgressRequestBody);
        ...
        if (mProgressResponseBody != null){
            Log.i(TAG,"mProgressResponseBody:" + mProgressResponseBody);
